...
console.log(
  `Probabilidad |0⟩: ${qubitSuperposition.getProbabilityZero().toFixed(3)}`
);
console.log(
  `Probabilidad |1⟩: ${qubitSuperposition.getProbabilityOne().toFixed(3)}`
);
console.log(
  `¿Está en superposición? ${qubitSuperposition.isInSuperposition()}\n`
);
...
console.log(
  `Probabilidad |1⟩: ${customQubit.getProbabilityOne().toFixed(3)}\n`
);
